...
__kernel void
lud_diagonal(__global double *m,
	     __local double *shadow, int matrix_dim, int offset)
{
    int i, j;
...
__kernel void
lud_perimeter(__global double *m,
	      __local double *dia,
	      __local double *peri_row,
	      __local double *peri_col, int matrix_dim, int offset)
{
...
__kernel void
lud_internal(__global double *m,
	     __local double *peri_row,
	     __local double *peri_col,
